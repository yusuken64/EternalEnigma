...
Status: **in progress**. Phase 1 (class data and assignment) is implemented; see the phase notes. It defines ten
...
- **Three mastery passives:** Novice Training → Adept Training → Master Training.
  ...
  weapons. Mastery skill names are prefixed with the class (for example *Warrior Novice Training*) because skills are saved by name and each class's masteries differ.
...
- **Level gate:** rank *n* needs hero level ≥ tier unlock level + 3 × (*n* − 1). Hero level here means the **highest level the hero has reached** in any dungeon run (saved as `HighestLevel`), because dungeon levels reset to 1 at the start of each run.
...
- **Save format:** learned skill names stay in `Skills`; ranks are saved in a parallel `SkillRanks` list (`SkillName` + `Rank`). A learned skill with no `SkillRanks` entry is rank 1.
...
|---|---|---|---|---|---|
| 1 | Warrior Novice Training | 1 M | Passive | Self | Unlocks tier 1. +5% damage with swords/axes/hammers. |
...
| 7 | Warrior Adept Training | 2 M | Passive | Self | Unlocks tier 2. +5% weapon damage. |
...
| 16 | Warrior Master Training | 3 M | Passive | Self | Unlocks tier 3. +5% weapon damage. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Guardian Novice Training | 1 M | Passive | Self | Unlocks tier 1. +1 Defense with a shield equipped. |
| 2 | Mining | 1 G | Passive | Self | Can harvest ore points. |
...
| 8 | Guardian Adept Training | 2 M | Passive | Self | Unlocks tier 2. +1 Defense with a shield. |
...
| 16 | Guardian Master Training | 3 M | Passive | Self | Unlocks tier 3. +1 Defense with a shield. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Archer Novice Training | 1 M | Passive | Self | Unlocks tier 1. +5% bow damage. |
...
| 8 | Archer Adept Training | 2 M | Passive | Self | Unlocks tier 2. +5% bow damage. |
...
| 16 | Archer Master Training | 3 M | Passive | Self | Unlocks tier 3. +5% bow damage. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Elementalist Novice Training | 1 M | Passive | Self | Unlocks tier 1. +5% elemental damage. |
...
| 8 | Elementalist Adept Training | 2 M | Passive | Self | Unlocks tier 2. +5% elemental damage. |
...
| 15 | Elementalist Master Training | 3 M | Passive | Self | Unlocks tier 3. +5% elemental damage. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Healer Novice Training | 1 M | Passive | Self | Unlocks tier 1. +10% healing. |
| 2 | Harvesting | 1 G | Passive | Self | Can harvest plant points. |
...
| 7 | Healer Adept Training | 2 M | Passive | Self | Unlocks tier 2. +10% healing. |
...
| 14 | Healer Master Training | 3 M | Passive | Self | Unlocks tier 3. +10% healing. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Bard Novice Training | 1 M | Passive | Self | Unlocks tier 1. Songs +1 turn. |
| 2 | Foraging | 1 G | Passive | Self | Can harvest forage points. |
...
| 7 | Bard Adept Training | 2 M | Passive | Self | Unlocks tier 2. Songs +1 turn. |
...
| 14 | Bard Master Training | 3 M | Passive | Self | Unlocks tier 3. Songs +1 turn. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Occultist Novice Training | 1 M | Passive | Self | Unlocks tier 1. +10% ailment chance. |
| 2 | Harvesting | 1 G | Passive | Self | Can harvest plant points. |
...
| 7 | Occultist Adept Training | 2 M | Passive | Self | Unlocks tier 2. +10% ailment chance. |
...
| 15 | Occultist Master Training | 3 M | Passive | Self | Unlocks tier 3. +10% ailment chance. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Rogue Novice Training | 1 M | Passive | Self | Unlocks tier 1. +5% evasion. |
| 2 | Foraging | 1 G | Passive | Self | Can harvest forage points. |
...
| 7 | Rogue Adept Training | 2 M | Passive | Self | Unlocks tier 2. +5% evasion. |
...
| 15 | Rogue Master Training | 3 M | Passive | Self | Unlocks tier 3. +5% evasion. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Commander Novice Training | 1 M | Passive | Self | Unlocks tier 1. Commands +1 turn. |
| 2 | Mining | 1 G | Passive | Self | Can harvest ore points. |
...
| 8 | Commander Adept Training | 2 M | Passive | Self | Unlocks tier 2. Commands +1 turn. |
...
| 15 | Commander Master Training | 3 M | Passive | Self | Unlocks tier 3. Commands +1 turn. |
...
| # | Skill | Tier | Type / SP | Target | Effect |
|---|---|---|---|---|---|
| 1 | Scout Novice Training | 1 M | Passive | Self | Unlocks tier 1. Hunger drains 10% slower. |
...
| 7 | Scout Adept Training | 2 M | Passive | Self | Unlocks tier 2. Hunger drains 10% slower. |
...
| 14 | Scout Master Training | 3 M | Passive | Self | Unlocks tier 3. Hunger drains 10% slower. |
...
Implementation notes: class assets are generated by **Tools > Eternal Enigma > Classes > Create Missing Class Definitions** (`Assets/Resources/Classes/`). Weapon rules use `WeaponType`; run **Tools > Eternal Enigma > Classes > Repair Weapon Types** once, because the weapon assets' serialized `WeaponType` values were shifted relative to the enum. Sticks, needles, axes and hammers share the `SingleSword`/`OffhandSword` types, so class weapon lists are expressed with those. The protagonist picker is built in code (`ProtagonistClassPicker`).
...
- **Learned skills:**
  - `TownAllyData.Skills` / `TownAlly.Skills` stay name lists. Ranks live in a
    parallel `SkillRanks` list (`SkillRankSaveData { SkillName, Rank }`); a
    missing entry means rank 1.
  - `TownAllyData.HighestLevel` / `TownAlly.HighestLevel` record the highest
    dungeon level reached. `DungeonReturnService.Commit` raises it on every
    return; the trainer uses it for the level gate.
  - At runtime each ally gets its own `Skill` instance
    (`SkillManager.GetSkillInstanceByName`), and `Game.cs` sets that instance's
    `Rank`, so `CanCast`, the skill menu and passives read ranks from the instance.
  - Each hero is granted their primary class's tier 1 mastery (Novice Training)
    at rank 1 when created, restored or recruited.
- **Trainer (`TownServices.Learn`, `BallistaDialog`, `SkillGridItem`):**
  ...
  - `TownConfiguration.LearnableSkills` becomes an optional per-town allowlist
    ...
    offered.
  - Heroes without a class (no `PrimaryClass`) keep the old behaviour: the town's
    `LearnableSkills` list, one rank each.
- **Tests:**
...
- Content is generated by **Tools > Eternal Enigma > Classes > Generate All Class Content**; skill assets live in `Assets/Resources/Classes/Skills/<Class>/` (shared skills in `Shared/`; HP Up reuses the legacy asset).
- SP costs: Low 1, Med 2, High 3. Learn costs: tier 1/2/3 = 50/150/400 gold; masteries 0/300/800 (the tier-1 mastery is granted free). Each rank costs learn cost × rank.
- Damage skills scale with Strength (weapon/bow) or with level (spells: base + per-level, half of Defense applies); heals scale with level. Ranks add +15% power.
- Single-rank or low-rank skills: masteries, gathering skills, unlock-style passives, cleanses, revives, Amplify, Quickstep, Discord, Plague, Dominate, Retreat, Floor Sense, Grapple Line and Command: Advance have 1 rank; songs, commands, Clone, Encore, Grand Finale, Field Kitchen and Farsight have 3; HP Regen has 3.
- Starting stat bonus per class: Warrior +5 HP/+1 Str; Guardian +10 HP/+2 Def; Archer +1 Str/+5% hit; Elementalist −4 HP/+5 SP; Healer +4 SP; Bard +2 HP/+2 SP; Occultist −4 HP/+4 SP; Rogue +1 Str/+5% evasion; Commander +3 HP/+3 SP; Scout +2 HP/+20 hunger.
- Hero classes: Avery, Rowan (default protagonist), Blake (+Guardian) — Warrior; Morgan, Dakota — Guardian; Quinn, Cameron, Taylor MC23 (+Scout) — Archer; Alex MC05, Finley — Elementalist; Jordan, Sage, Charlie (+Elementalist) — Healer; Riley, Harper — Bard; Casey, Reese — Occultist; Taylor MC09, Logan, Alex MC24 (+Occultist) — Rogue; Jamie, Kai — Commander; Skylar, Sydney — Scout.
- Bosses: Dragon and Demon King. Enemy elemental resistances are authored per enemy (see `TuneEnemyResistances`).
- Simplifications versus the tables: Follow-up Mastery gives a 30% chance for a follow-up to strike twice; Aegis makes barriers last one extra turn; Sanctuary Wall gives each visible ally a 10-damage shield; Parry Stance blocks hits from adjacent attackers; Resourceful is a 25% chance not to use up a consumable; Throwing Arm raises thrown damage only; Take Point gives the whole party +1 action on the first turn of each floor; Aura of Command restores 1 SP every 3 turns to allies within 2 tiles.
- Balance is tuned with Autoplay runs (see `Docs/ClassesVerification/Phase7.md`).
